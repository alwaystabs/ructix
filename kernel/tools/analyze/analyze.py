...
class RuctixAnalyzer:
    def __init__(self, root_path: str):
        ...
        self.history_file = self.root_path / '.code_stats.json'
    ...
    def scan(self):
        ...
        for f in files:
            ...
            self.results['by_dir'][dir_path]['files'] += 1
            self.results['by_dir'][dir_path]['lines'] += total
